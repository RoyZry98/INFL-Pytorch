    ...
    for rnd in range(args.global_round):
        ...
        if len(score_list) > 0:
            ...
            if cur_score < best_score:
                ...
                best_round = rnd + 1
                save_dir   = f'Ada_INFL_8_logs_0.4_pe'
        ...
        os.makedirs('Ada_INFL_8_logs_0.4_pe', exist_ok=True)
        df.to_csv('Ada_INFL_8_logs_0.4_pe/fed_test_metrics.csv', index=False)
        ...
        plt.savefig('Ada_INFL_8_logs_0.4_pe/test_mse_curve.png', dpi=300)
        plt.close()                               # 释放内存
        ...
        plt.savefig('Ada_INFL_8_logs_0.4_pe/subgroup_mse_curve.png', dpi=300)
        plt.close()
