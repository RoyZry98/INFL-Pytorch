...
from spamosaic.train_utils import set_seeds, train_model, train_model_with_dp, train_model_with_multimodal_dp
...
class SpaMosaic(object):
    ...
    def train(self, net, lr, use_mini_thr=8000, mini_batch_size=1024, loss_type='adapted', T=0.01, bias=0, n_epochs=100, w_rec_g=0., dp=False, max_grad_norm=1.0, noise_std=0.5):
        ...
        if dp:
            ...
            mod_model, loss_cl, loss_rec, loss = train_model_with_multimodal_dp(
